...
class UtilFunctions
{
    ...
    public static function convertDateForEvent($dateStr)
    {
    ...
    {     
                    ...
                    ->setFrom(['crm@brasslineindia.com'=>'Brasslineindia'])
                    ->setBcc(array('wagtaildevelopment@gmail.com','brasslineindia@gmail.com'))
                    ->setTo($to)
                    ->setSubject($subject)
                    ->setHtmlBody($body)
                    ->send();
