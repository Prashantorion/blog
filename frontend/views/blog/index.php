                ...
                ?>
                    <div class="article wow slideInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">
                        <div class="text-right">
                            <a href="<?= yii::$app->homeUrl ?>blog/blogs_details?name=<?= $blog->id?>" class="article-image">
                                <figure>
                        ...
                        <div class="article-text">
                            ...
                            <h3><a href="<?= yii::$app->homeUrl ?>blog/blogs_details?name=<?= $blog->news_title?>"><?= $blog->news_title?></a></h3>
                            <p><?= $blog->news_title?></p>
