...
! function(t) {
    ...
    var u = t(window),
        ...
        k = /\d+/g,
        v = /^\d{2,4}$/,
        D = ["datepicker-top-left", "datepicker-top-right", "datepicker-bottom-left", "datepicker-bottom-right"].join(" "),
        C = "datepicker-hide",
        b = {
            DAYS: 0,
            MONTHS: 1,
    ...
    c.prototype = {
        ...
        showView: function(t) {
            ...
            if (a.hasYear || a.hasMonth || a.hasDay) switch (g(t)) {
                case b.YEARS:
                case "years":
                    i.addClass(C), s.addClass(C), a.hasYear ? (this.fillYears(), e.removeClass(C), this.place()) : this.showView(b.DAYS);
                    break;
                case b.MONTHS:
                case "months":
                    e.addClass(C), s.addClass(C), a.hasMonth ? (this.fillMonths(), i.removeClass(C), this.place()) : this.showView(b.YEARS);
                    break;
                default:
                    e.addClass(C), i.addClass(C), a.hasDay ? (this.fillDays(), s.removeClass(C), this.place()) : this.showView(b.MONTHS)
            }
        },
        hideView: function() {
        ...
        place: function() {
            if (!this.isInline) {
                ...
                c > l && c + h + l > a ? (c -= l + u, p = "datepicker-bottom-left") : c += h + u, d + r > s && (d = d + n - r, p = p.replace("left", "right")), i.removeClass(D).addClass(p).css({
                    top: c,
                    left: d,
        ...
        fillYears: function() {
            var e, i = this.options,
                ...
                v = !1,
                D = "";
            for (e = -5; e <= 6; e++) f = new Date(o + e, d, c), v = -5 === e || 6 === e, k = o + e === g, y = !1, h && (y = f.getFullYear() < h.getFullYear(), -5 === e && (w = y)), !y && r && (y = f.getFullYear() > r.getFullYear(), 6 === e && (m = y)), !y && n && (y = !1 === n.call(this.$element, f)), D += this.createItem({
                text: o + e,
        ...
        fillMonths: function() {
            var e, i = this.options,
                ...
                v = !1,
                D = "";
            for (e = 0; e <= 11; e++) f = new Date(o, e, d), v = o === g && e === w, k = !1, h && (m = f.getFullYear() === h.getFullYear(), k = m && f.getMonth() < h.getMonth()), !k && r && (y = f.getFullYear() === r.getFullYear(), k = y && f.getMonth() > r.getMonth()), !k && n && (k = !1 === n.call(this.$element, f)), D += this.createItem({
                index: e,
                text: a[e],
        ...
        fillDays: function() {
            var e, i, s, a = this.options,
                ...
                A = [],
                N = [];
            for (0 === g ? (w -= 1, m = 11) : m -= 1, e = o(w, m), $ = new Date(f, g, 1), s = $.getDay() - l, s <= 0 && (s += 7), c && (F = $.getTime() <= c.getTime()), i = e - (s - 1); i <= e; i++) $ = new Date(w, m, i), T = w === S && m === x && i === M, Y = !1, c && (Y = $.getTime() < c.getTime()), !Y && d && (Y = !1 === d.call(this.$element, $)), V.push(this.createItem({
                text: i,
                view: "day prev",
                muted: !0,
                picked: T,
            ...
            for (11 === g ? (y += 1, b = 0) : b += 1, e = o(f, g), s = 42 - (V.length + e), $ = new Date(f, g, e), u && (I = $.getTime() >= u.getTime()), i = 1; i <= s; i++) $ = new Date(y, b, i), T = y === S && b === x && i === M, Y = !1, u && (Y = $.getTime() > u.getTime()), !Y && d && (Y = !1 === d.call(this.$element, $)), A.push(this.createItem({
                text: i,
                view: "day next",
                muted: !0,
                picked: T,
            ...
            for (i = 1; i <= e; i++) $ = new Date(f, g, i), T = f === S && g === x && i === M, Y = !1, c && (Y = $.getTime() < c.getTime()), !Y && u && (Y = $.getTime() > u.getTime()), !Y && d && (Y = !1 === d.call(this.$element, $)), N.push(this.createItem({
                text: i,
            ...
            this.$monthPrev.toggleClass(n, F), this.$monthNext.toggleClass(n, I), this.$monthCurrent.toggleClass(n, F && I).html(a.yearFirst ? f + h + " " + r[g] : r[g] + " " + f + h), this.$days.html(V.join("") + N.join(" ") + A.join(""))
        },
        click: function(e) {
            ...
            if (e.stopPropagation(), e.preventDefault(), !l.hasClass("disabled")) switch (i = d.getFullYear(), s = d.getMonth(), a = d.getDate(), r = l.data("view")) {
                case "years prev":
                case "years next":
                    i = "years prev" === r ? i - 10 : i + 10, h = l.text(), n = v.test(h), n && (i = parseInt(h, 10), this.date = new Date(i, s, $(a, 28))), this.viewDate = new Date(i, s, $(a, 28)), this.fillYears(), n && (this.showView(b.MONTHS), this.pick("year"));
                    break;
                case "year prev":
                case "year next":
                    i = "year prev" === r ? i - 1 : i + 1, this.viewDate = new Date(i, s, $(a, 28)), this.fillMonths();
                    break;
                case "year current":
                    this.format.hasYear && this.showView(b.YEARS);
                    break;
                case "year picked":
                    this.format.hasMonth ? this.showView(b.MONTHS) : (l.addClass(o.pickedClass).siblings().removeClass(o.pickedClass), this.hideView()), this.pick("year");
                    break;
                case "year":
                    i = parseInt(l.text(), 10), this.date = new Date(i, s, $(a, 28)), this.format.hasMonth ? (this.viewDate = new Date(i, s, $(a, 28)), this.showView(b.MONTHS)) : (l.addClass(o.pickedClass).siblings().removeClass(o.pickedClass), this.hideView()), this.pick("year");
                    break;
                case "month prev":
                case "month next":
                    s = "month prev" === r ? s - 1 : "month next" === r ? s + 1 : s, this.viewDate = new Date(i, s, $(a, 28)), this.fillDays();
                    break;
                case "month current":
                    this.format.hasMonth && this.showView(b.MONTHS);
                    break;
                case "month picked":
                    this.format.hasDay ? this.showView(b.DAYS) : (l.addClass(o.pickedClass).siblings().removeClass(o.pickedClass), this.hideView()), this.pick("month");
                    break;
                case "month":
                    s = t.inArray(l.text(), o.monthsShort), this.date = new Date(i, s, $(a, 28)), this.format.hasDay ? (this.viewDate = new Date(i, s, $(a, 28)), this.showView(b.DAYS)) : (l.addClass(o.pickedClass).siblings().removeClass(o.pickedClass), this.hideView()), this.pick("month");
                    break;
                case "day prev":
                case "day next":
                case "day":
        ...
        show: function() {
            this.isBuilt || this.build(), this.isShown || this.trigger("show.datepicker").isDefaultPrevented() || (this.isShown = !0, this.$picker.removeClass(C).on(m, t.proxy(this.click, this)), this.showView(this.options.startView), this.isInline || (u.on("resize.datepicker", this._place = r(this.place, this)), f.on(m, this._clickDoc = r(this.clickDoc, this)), f.on("keyup.datepicker", this._keyupDoc = r(this.keyupDoc, this)), this.place()))
        },
        hide: function() {
            this.isShown && (this.trigger("hide.datepicker").isDefaultPrevented() || (this.isShown = !1, this.$picker.addClass(C).off(m, this.click), this.isInline || (u.off("resize.datepicker", this._place), f.off(m, this._clickDoc), f.off("keyup.datepicker", this._keyupDoc))))
        },
        toggle: function() {
        ...
        getMonthName: function(e, i) {
            var n = this.options,
                h = n.months;
            return t.isNumeric(e) ? e = g(e) : a(i) && (i = e), !0 === i && (h = n.monthsShort), h[s(e) ? e : this.date.getMonth()]
        },
        getDayName: function(e, i, n) {
            var h = this.options,
                r = h.days;
            return t.isNumeric(e) ? e = g(e) : (a(n) && (n = i), a(i) && (i = e)), r = !0 === n ? h.daysMin : !0 === i ? h.daysShort : r, r[s(e) ? e : this.date.getDay()]
        },
        getDate: function(t) {
            var e = this.date;
        ...
        setDate: function(e, s) {
            ...
            if (n(e) || i(e)) {
                if (e = this.parseDate(e), t.isFunction(a) && !1 === a.call(this.$element, e)) return;
        ...
        parseDate: function(t) {
            ...
            if (i(t) && (d = t.match(k) || []), t = new Date, s = t.getFullYear(), a = t.getDate(), h = t.getMonth(), e = o.parts.length, d.length === e)
